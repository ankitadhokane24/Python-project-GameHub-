...
b1=Button(text="tic tac  toe", fg="red",command=tic_tac_toe)
b1.pack()
b2=Button(text="Snake Game",fg="blue",command=snake_game)
b2.pack()
b3=Button(text="Egg Catcher",fg="green",command=egg_catcher)
b3.pack()
b4=Button(text="Rock Paper Scissor",fg="purple",command=rock_paper_scissor)
b4.pack()
b5=Button(text="Guess The Number",fg="indigo",command=guess_no)
b5.pack()
